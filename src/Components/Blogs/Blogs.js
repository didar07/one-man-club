...
const blogs = () => {
    return (
        <div>
            ...
            <div>
                <h1>What are the side effects of useeffect?</h1>
                <p>Some examples of side effects are: fetching data, directly updating the DOM, and timers. useEffect accepts two arguments. The second argument is optional. Let's use a timer as an example.</p>
            </div>
        </div>
    );
};
